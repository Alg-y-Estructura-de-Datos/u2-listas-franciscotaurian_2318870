...
void printLista(Lista<int> &lista, int p)
{
    ...
    if (p >= tamanio || p < 0)
    {
        cout << "La posicion: " << p << ". Esta fuera de la lista" << endl;
    }
...
int main()
{
    ...
    Lista<int> Lista1; // llamo la clase, le declaro el tipo de dato que voy a almacenar y creo el objeto.#
    ...
    cout<<"Ingrese la posicion desde donde quiere imprimir la lista"<<endl;
    cin>>p;
